...
#   修改路径
#--------------------------------------------#
img_path = 'datasets(1)/cars'  # 原始数据路径
aug_img_path = 'datasets(1)/cars_aug'  # 增强数据路径
aug_xml_path = 'datasets(1)/cars_aug_xml'  # 增强标注路径

valid_path = 'datasets(1)/validcar'  # 有效数据保存路径
valid_xml_path = 'datasets(1)/validcar_xml'  # 有效数据xml保存路径
invalid_path = 'datasets(1)/invalidcar'  # 无效数据保存路径
invalid_xml_path = 'datasets(1)/invalidcar_xml'  # 无效数据xml保存路径
